...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    ...
    twitter: { card: "summary", title: `${cat.name} — Sadrax`, description: desc },
  };
}
...
export default async function CategoryPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      {/* Sticky sub-header — sticks at top of the right column / viewport */}
      ...
      {/* Products */}
      <div className="flex-1 px-3 py-3 md:px-5 md:py-5">
